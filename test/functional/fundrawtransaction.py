...
class RawTransactionsTest(ScicoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid scicoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        scicoind_processes[1].wait(timeout=SCICOIND_PROC_WAIT_TIMEOUT)
