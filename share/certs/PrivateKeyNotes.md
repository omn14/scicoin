...
unlocked to sign the Scicoin-Qt.app bundle.
...
allowing somebody to distribute a Scicoin-Qt.app or scicoin-qt-setup.exe with a valid
...
that the scicoin-qt.exe file inside the installer had not been tampered with.
