 ...
 */
#ifndef SCICOIN_UTIL_H
#define SCICOIN_UTIL_H
...
extern const char * const SCICOIN_CONF_FILENAME;
extern const char * const SCICOIN_PID_FILENAME;
...
{
    std::string s = strprintf("scicoin-%s", name);
