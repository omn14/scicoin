 ...
 * between scicoind, and scicoin-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), SCICOIN_CONF_FILENAME));
    if (mode == HMM_SCICOIND)
    {
#if HAVE_DECL_DAEMON
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), SCICOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/scicoin/scicoin>";
    const std::string URL_WEBSITE = "<https://scicoincore.org>";
...
/** Sanity checks
 *  Ensure that Scicoin is running in a usable environment with all
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(GetArg("-conf", SCICOIN_CONF_FILENAME)).string());
