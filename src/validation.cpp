...
#if defined(NDEBUG)
# error "Scicoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Scicoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SCC additional fees, %d delta bytes\n",
...
LogPrintf("With time end, og res= %b\n",res);
    return res;
}
...
{
//Ole edit: printing ...
LogPrintf("MMMMMMMMMMMMMM: checking if accepted to mempool\n");
