...
#ifndef SCICOIN_TEST_SCRIPTNUM10_H
#define SCICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Scicoin Core 0.10.0, for cross-comparison.
 */
public:
