...
#ifndef SCICOIN_QT_SCICOINUNITS_H
#define SCICOIN_QT_SCICOINUNITS_H
...
/** Scicoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ScicoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ScicoinUnits(QObject *parent);

    /** Scicoin units.
      @note Source: https://en.scicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SCC,
...
typedef ScicoinUnits::Unit ScicoinUnit;

#endif // SCICOIN_QT_SCICOINUNITS_H
