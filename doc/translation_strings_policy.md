...
This document provides guidelines for internationalization of the Scicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `scicoin_en.ts` remains unchanged.
